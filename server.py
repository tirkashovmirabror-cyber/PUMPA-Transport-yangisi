...
STATUS_MESSAGES = {
    "waiting": "⏳ PUMPA Kids Transport hozircha kutilmoqda.",
    "started": "🚐 PUMPA Kids Transport yo'lga chiqdi — shoshiling!",
    "picked_up": "🧒 PUMPA Kids Transport bolalarni oldi, yo'lda.",
    "arrived": "🏁 PUMPA Kids Transport yetib keldi!",
}
...
def set_route(x: RouteStatus):
    ...
    if x.status == "started":
        trip_state["yaqinlashdi_xabar_yuborildi"] = False
    message = STATUS_MESSAGES.get(x.status)
    if message:
        broadcast_to_parents(message)
